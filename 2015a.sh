...
communitylist="kernel ltp swarm distribution libnetwork machine kpatch logrus coder mcelog syslog-ng docker-bench-security notary f2fs-tools specs nfs-ganesha openembedded-core meta-openembedded uclibc-ng busybox"
#communitylist="kernel runc ltp swarm distribution libnetwork machine kpatch logrus coder mcelog syslog-ng docker-bench-security notary f2fs-tools specs nfs-ganesha openembedded-core meta-openembedded uclibc-ng busybox"
