...
微服务将软件细分为多个子模块，各模块间相对独立，便于测试进行迁移以便及早的发现缺陷。Devops通过成熟的自动化解决方案，同时配合容器、微服务技术，打通了开发、测试、运维团队的壁垒。感兴趣的读者可以阅读[《Docker引领测试革新》](http://www.infoq.com/cn/articles/docker-lead-test-innovation)。
