...
## 4.测试工程师参与开源社区的方式
(1)添加测试用例<br>
测试用例的编写是测试工程师的本职工作。很多开源社区非常愿意吸收新的测试用例合入。在Docker社区，相比于开发代码，测试代码更易于合入。
(2)书写或补充文档<br>
很多社区都因为缺少必要的文档，导致客户无法正确使用软件。开发书写的文档往往会出现跳步的情况，需要测试者对文档的书写进行校正。<br>
(3)修改软件缺陷或添加新功能<br>
测试者也可以修改软件的缺陷和添加测试所需的新功能，这包含一些可测试性的功能开发。
(4)测试待发布版本<br>
测试待发布的版本来保证软件发布质量，这是测试者最重要的工作职责。
(5)补充专项测试方案<br>
补充一些专项测试（性能、长稳、安全、异常边界、安全)来完善质量保证体系。
(6)提交软件缺陷和回答社区中的问题<br>
社区往往会通过issue列表或邮件列表对已有问题进行讨论，测试可以提交缺陷或者回答其他人的提问来与社区进行互动。
(7)设计开源测试工具<br>
